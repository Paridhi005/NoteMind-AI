      ...
      <div className="flex-1 p-8">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition cursor-pointer">
              <div className="text-3xl mb-3">🔒</div>
              <h3 className="font-semibold">Cyber Security</h3>
              <p className="text-sm text-slate-500 mt-2">8 Documents</p>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition cursor-pointer">
              <div className="text-3xl mb-3">☕</div>
              <h3 className="font-semibold">Java</h3>
              <p className="text-sm text-slate-500 mt-2">12 Documents</p>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition cursor-pointer">
              <div className="text-3xl mb-3">🤖</div>
              <h3 className="font-semibold">Machine Learning</h3>
              <p className="text-sm text-slate-500 mt-2">15 Documents</p>
            </div>

            <div className="bg-white p-6 rounded-2xl shadow-sm hover:shadow-lg hover:-translate-y-1 transition cursor-pointer">
              <div className="text-3xl mb-3">📖</div>
              <h3 className="font-semibold">Research Methodology</h3>
              <p className="text-sm text-slate-500 mt-2">5 Documents</p>
            </div>
          </div>
        </div>
